import { Observable, BehaviorSubject, Subject, firstValueFrom, filter, take, timeout, map, switchMap, EMPTY, timestamp, shareReplay } from 'rxjs';
...
var WebSerialDevice = /** @class */ (function () {
    function WebSerialDevice() {
        var _this = this;
        this.deviceState$ = new BehaviorSubject("closed");
        ...
        this.waitUntilOpened = function (timeoutMilli) {
            ...
            if (timeoutMilli > 0) {
                return firstValueFrom(_this.deviceState$.pipe(filter(function (it) { return it === "opened"; }), take(1), timeout({ first: timeoutMilli }), map(function () { return true; })));
            }
            else {
                return firstValueFrom(_this.deviceState$.pipe(filter(function (it) { return it === "opened"; }), take(1), map(function () { return true; })));
            }
        };
        /**
         * implement IDevice
        ...
        this.observeReceivedData = function () {
            return _this.deviceState$.pipe(switchMap(function (state) { return (state === "opened" ? _this.receivedData$.asObservable() : EMPTY); }));
        };
        /**
         * 연결 여부
         * implement IDevice
    ...
    function WiseXboardControl(device_) {
        ...
        this.readNext_ = function (ctx) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, firstValueFrom(this.chunk$.pipe(filter(function (it) { return it.timestamp > minTimestamp; }), map(function (it) { return it.value; })))];
            });
        }); };
        this.observeData = function () {
            return _this.chunk$.pipe(map(function (it) { return it.value; }));
        };
        ...
        this.chunk$ = this.device_.observeReceivedData().pipe(map(function (it) { return it.dataBuffer; }), DelimiterParser.parse({
            delimiter: DELIMITER$1,
            includeDelimiter: false
        }), timestamp(), shareReplay(1));
    }
    // isReadable = (): boolean => {
...
export { DelimiterParser, WebSerialDevice, hardwares };
